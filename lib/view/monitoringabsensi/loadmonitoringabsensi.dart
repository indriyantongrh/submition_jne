...
class loadmonitoringabsensi extends StatefulWidget {
  @override
  _loadmonitoringabsensiState createState() => _loadmonitoringabsensiState();
}

class _loadmonitoringabsensiState extends State<loadmonitoringabsensi> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body:FutureBuilder(
          future: ApiProvider().fetchMonitoringAbsen(idKaryawan),
